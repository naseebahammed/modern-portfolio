                ...
                experienceData.map((exp) => {
                  return (
                    <div className="experience-card" key={exp.id}>
                      <div className="experience-card_heading">
                        {exp.jobRole}
                      </div>
                      <div className="experience-card_company">
                        {exp.company}
                      </div>
                      <div className="experience-card_place">{exp.place}</div>
                      <div className="experience-card_duration">
                        {exp.duration}
                      </div>
                      <button className="experience-card_button">
                        Know More
                      </button>
                    </div>
                  );
